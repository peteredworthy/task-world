...
Product-scope FR rows remain `partial` except FR-03, FR-04, FR-05, FR-06, FR-08, FR-10,
...
4. FR-09 remains partial for packet/readback coverage of less-used node kinds.
