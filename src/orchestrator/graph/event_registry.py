...
EVENT_PAYLOAD_MODELS: MappingProxyType[str, type[BaseModel]] = MappingProxyType(
    {
        ...
        "decision_answer_rejected": DecisionAnswerRejectionPayload,
        ...
        "runner_baseline_recorded": RunnerBaselineRecordedPayload,
        "runner_submission_staged": RunnerSubmissionStagedPayload,
        "runner_completion_witnessed": RunnerCompletionWitnessedPayload,
        "runner_boundary_mismatch": RunnerBoundaryMismatchPayload,
        "runner_recovery_requested": RunnerRecoveryRequestedPayload,
        "runner_recovery_completed": RunnerRecoveryCompletedPayload,
        "runner_execution_finalized": RunnerExecutionFinalizedPayload,
