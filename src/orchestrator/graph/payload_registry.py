...
EVENT_PAYLOAD_SPECS: MappingProxyType[str, EventPayloadSpec] = MappingProxyType(
    {
        ...
        "node_created": _spec(
            ...
            node_detail="acceptance_command_timeout_seconds accepted_baseline_failure_fingerprints acceptance acceptance_commands allowed_actions approval_prompt approval_type attempt_number authority authority_request authority_request_record authority_request_record_id base_snapshot_candidate_id base_snapshot_region_id base_snapshot_selection blocker blocker_reason bound_requirement_ids candidate_id command_binding command_definition command_definition_id declared_batch_id declared_batch_ids decision_request decision_request_record_id effect_contract execution_id failed_candidate_id final_audit_required gate_type generation_index guarded_planner_node_id hidden_oracle_command human_prompt id inputs invariants kind max_attempts membership message node_id objective outputs planner_chain planner_generation_budget planning_horizon preconditions priority prohibited_actions prompt reason recovery_of_node_id recovery_of_record_id recovery_reason region_label rejected_patch_id reliable_plan_one_horizon_authorized reliable_plan_qualification_evidence_hash reliable_plan_skeleton_id reliable_plan_successor_model reliable_plan_successor_profile runner_model_override requirement requirement_id resource_claims role rubric scope semantic_schema_id semantic_schema_version semantic_stage session_id state task_region_id work_mode",
        ),
