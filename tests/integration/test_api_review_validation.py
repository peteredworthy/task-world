"""Integration smoke tests for review API router-level validation.

Pure Pydantic validators (FilePrune.mode, PruneSelection.scope, RevertFileRequest)
are tested in tests/unit/test_api_review_validation.py.

This file covers the diff scope validation that lives in the router itself and
therefore requires an HTTP request to exercise.
"""
...
# --- Diff scope validation (router-level) ---
