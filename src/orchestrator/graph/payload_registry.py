...
EVENT_PAYLOAD_SPECS: MappingProxyType[str, EventPayloadSpec] = MappingProxyType(
    {
        ...
        "callback_accepted": _spec(
            "callback_accepted",
            projection="execution_id idempotency_key lease_generation lease_id node_id payload payload_hash payload_size_bytes record_ids reason",
            light="execution_id lease_generation lease_id node_id reason",
            summary="execution_id idempotency_key lease_generation lease_id node_id payload payload_hash payload_size_bytes record_ids reason",
            node_detail="execution_id idempotency_key lease_generation lease_id node_id reason",
        ),
        "callback_duplicate_returned": _spec(
            "callback_duplicate_returned",
            projection="execution_id idempotency_key lease_generation lease_id node_id payload payload_hash payload_size_bytes record_ids prior_result reason",
            light="execution_id lease_generation lease_id node_id reason",
            summary="execution_id idempotency_key lease_generation lease_id node_id payload payload_hash payload_size_bytes record_ids reason",
        ...
        "command_rejected": _spec(
            ...
            light="patch_id proposed_by_node_id reason rejection_evidence",
        ...
        "file_state_accepted": _spec(
            "file_state_accepted",
            projection="base_snapshot_id candidate_id git paths port producer_node_id record_id record_kind record_type schema snapshot_id supersedes_record_id task_region_id verdict",
            ...
            node_detail="base_snapshot_id candidate_id paths patch_bundle_id port producer_node_id record_id record_kind schema supersedes_record_id task_region_id verdict",
        ),
        "file_state_rejected": _spec(
            "file_state_rejected",
            projection="base_snapshot_id candidate_id git paths port producer_node_id reason record_id record_kind record_type schema snapshot_id supersedes_record_id task_region_id verdict",
            ...
            node_detail="base_snapshot_id candidate_id paths patch_bundle_id port producer_node_id reason record_id record_kind schema supersedes_record_id task_region_id verdict",
        ),
        ...
        "graph_patch_accepted": _spec(
            ...
            projection="base_graph_position carryover_record_id operation_fingerprint operation_key patch_id proposed_by_node_id session_id successor_planner_node_ids",
        ...
        "graph_patch_rejected": _spec(
            ...
            light="patch_id proposed_by_node_id reason rejection_evidence",
            summary="actor_role patch_id proposed_by_node_id reason rejection_reason rejection_evidence",
            node_detail="reason",
        ),
        ...
        "node_created": _spec(
            "node_created",
            projection="acceptance_command_timeout_seconds accepted_baseline_failure_fingerprints accepted_plan_amendment_record_id acceptance_commands access_mode access_mode_override_justification acceptance allowed_actions appealed_node_id approval_prompt approval_type artifacts attempt_number authority authority_request authority_request_record authority_request_record_id available_tools base_snapshot_candidate_id base_snapshot_region_id base_snapshot_selection blocker blocker_reason bound_requirement_ids builder_agent cache_authority_hash candidate_id carryover_record_id check_index classified_gap_record_id command_binding command_definition command_definition_id complexity context_source correction_trigger decision_request decision_request_record_id decision_successor_node_id declared_batch_id declared_batch_ids dynamic_feature effect_contract execution_id failed_candidate_id failed_check_record_ids failed_verification_record_id fan_out final_audit_required gate gate_type generation_index guarded_planner_node_id hidden_oracle_command human_prompt id inputs invariants kind max_attempts mcp_servers membership message node_id objective outputs patch_id planner_chain planner_generation_budget planning_horizon preconditions priority profile prohibited_actions prompt reason recovery_of_node_id recovery_of_record_id recovery_reason region_label rejected_patch_id reliable_plan_assignment_carrier reliable_plan_assignment_role reliable_plan_one_horizon_authorized reliable_plan_qualification_evidence_hash reliable_plan_remaining_horizons reliable_plan_selected_runner_type reliable_plan_skeleton_id reliable_plan_successor_model reliable_plan_successor_profile runner_model_override requirement requirement_id resource_claims role routine rubric run_id scope semantic_schema_id semantic_schema_version semantic_stage session_id snapshot state step_context step_id step_index submission_template task_context task_id task_index task_region_id title verifier_agent work_mode",
            light="allowed_actions appealed_node_id approval_prompt approval_type attempt_number authority authority_request authority_request_record authority_request_record_id base_snapshot_candidate_id base_snapshot_region_id base_snapshot_selection blocker blocker_reason candidate_id command_binding command_definition command_definition_id decision_request decision_request_record_id execution_id failed_candidate_id gate_type generation_index guarded_planner_node_id hidden_oracle_command human_prompt id inputs kind max_attempts membership message node_id outputs planner_chain planner_generation_budget preconditions priority prompt reason recovery_of_node_id recovery_of_record_id recovery_reason region_label rejected_patch_id requirement requirement_id resource_claims role session_id state task_region_id",
            ...
            node_detail="acceptance_command_timeout_seconds accepted_baseline_failure_fingerprints acceptance acceptance_commands allowed_actions approval_prompt approval_type attempt_number authority authority_request authority_request_record authority_request_record_id base_snapshot_candidate_id base_snapshot_region_id base_snapshot_selection blocker blocker_reason bound_requirement_ids candidate_id classified_gap_record_id command_binding command_definition command_definition_id correction_trigger declared_batch_id declared_batch_ids decision_request decision_request_record_id effect_contract execution_id failed_candidate_id failed_check_record_ids failed_verification_record_id final_audit_required gate_type generation_index guarded_planner_node_id hidden_oracle_command human_prompt id inputs invariants kind max_attempts membership message node_id objective outputs planner_chain planner_generation_budget planning_horizon preconditions priority prohibited_actions prompt reason recovery_of_node_id recovery_of_record_id recovery_reason region_label rejected_patch_id reliable_plan_assignment_carrier reliable_plan_assignment_role reliable_plan_one_horizon_authorized reliable_plan_qualification_evidence_hash reliable_plan_remaining_horizons reliable_plan_selected_runner_type reliable_plan_skeleton_id reliable_plan_successor_model reliable_plan_successor_profile runner_model_override requirement requirement_id resource_claims role rubric scope semantic_schema_id semantic_schema_version semantic_stage session_id state task_region_id work_mode",
        ),
        ...
        "output_record_accepted": _spec(
            ...
            projection="attempt_number base_snapshot_id candidate_id candidate_record_id candidate_record_ids evaluated_record_ids evidence file_state_record_id file_state_record_ids outcome paths port producer_node_id provenance record_id record_kind record_type schema snapshot_id supersedes_record_id supersedes_task_region_id supersedes_task_region_ids task_region_id value verdict",
            ...
            node_detail="attempt_number base_snapshot_id candidate_id candidate_record_id candidate_record_ids evaluated_record_ids file_state_record_ids outcome patch_bundle_id paths port producer_node_id record_id record_kind schema supersedes_record_id task_region_id verdict",
        ),
        ...
        "runner_submission_staged": _spec(
            ...
            projection="execution_id node_id lease_id lease_generation idempotency_key payload payload_ref payload_hash payload_size_bytes staged_snapshot_id staged_snapshot_ref staged_commit_sha staged_tree_sha boundary_hash boundary_entries base_snapshot_id observed_graph_position is_mutating complete_node new_state owns_file_state_snapshot cache_authority_hash cache_roots cache_status_evidence validation_witness disposition",
            light="execution_id node_id lease_id lease_generation payload_hash payload_size_bytes boundary_hash disposition",
            summary="execution_id node_id lease_id lease_generation payload_hash payload_size_bytes boundary_hash disposition",
            node_detail="execution_id node_id lease_id lease_generation payload_hash payload_size_bytes boundary_hash disposition",
        ),
        "runner_completion_witnessed": _spec(
            "runner_completion_witnessed",
            projection="execution_id node_id lease_id lease_generation staged_payload_hash staged_payload_size_bytes staged_snapshot_id staged_snapshot_ref staged_commit_sha staged_tree_sha staged_boundary_hash runner_return_kind final_snapshot_id final_snapshot_ref final_commit_sha final_tree_sha boundary_hash boundary_entries cache_authority_hash cache_roots cache_status_evidence disposition",
            light="execution_id node_id lease_id lease_generation staged_payload_hash staged_boundary_hash runner_return_kind boundary_hash disposition",
            summary="execution_id node_id lease_id lease_generation staged_payload_hash staged_boundary_hash runner_return_kind boundary_hash disposition",
            node_detail="execution_id node_id lease_id lease_generation staged_payload_hash staged_boundary_hash runner_return_kind boundary_hash disposition",
        ),
        ...
        "runner_recovery_completed": _spec(
            ...
            projection="execution_id recovery_id node_id lease_id lease_generation baseline_snapshot_id baseline_tree_sha requested_paths proof_hash restored_paths removed_paths recovery_scope disposition",
            light="execution_id recovery_id node_id lease_id lease_generation proof_hash disposition",
            summary="execution_id recovery_id node_id lease_id lease_generation proof_hash disposition",
            node_detail="execution_id recovery_id node_id lease_id lease_generation proof_hash disposition",
        ),
        "runner_execution_finalized": _same(
            "runner_execution_finalized",
            "execution_id node_id lease_id lease_generation final_snapshot_id final_snapshot_ref final_commit_sha final_tree_sha boundary_hash boundary_entries cache_authority_hash cache_roots cache_status_evidence disposition",
        ),
