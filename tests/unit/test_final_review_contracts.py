...
COMMAND_EXAMPLES: dict[str, dict[str, Any]] = {
    ...
    "record_decision_answer_rejection": {
        ...
        "delivery_id": "d" * 64,
        "transport_channel": "codex_server",
        ...
        "failure_diagnostic": {
            ...
            "code": "decision_answer.invalid_payload",
            "message": "The submitted answer did not match the bound decision schema.",
            "next_action": "correct_answer",
            "correction_allowed": True,
            "protected_evidence_refs": ["artifact:sha256:" + "2" * 64],
        },
        "decision_answer_receipt_ref": {
            "artifact_id": "decision-answer-receipt-1",
            "content_hash": "sha256:" + "2" * 64,
            "size_bytes": 256,
            "media_type": "application/json",
            "encoding": "utf-8",
            "storage_uri": "artifact://sha256/" + "2" * 64,
        },
    },
    ...
    "record_managed_snapshot_cleanup_applied": {
        ...
        "snapshot_ref": "refs/orchestrator/snapshots/baseline-1",
        "tree_sha": "a" * 40,
        "commit_sha": "b" * 40,
        "node_id": "worker-1",
        "lease_id": "lease-1",
