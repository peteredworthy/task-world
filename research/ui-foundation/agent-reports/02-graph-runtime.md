...
| `reconcile` | terminal run → CR; otherwise repair guards may produce topology/retirement/terminal-failure events, or none | no new typed record directly | nodes,edges,bindings,verification/check indexes,`run_state` | none directly |
