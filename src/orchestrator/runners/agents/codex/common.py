...
def build_dynamic_tool_specs(
    ...
    planner_macro_specs: dict[str, dict[str, Any]] = {
            ...
            "inputSchema": {
                ...
                "properties": {
                    **macro_patch_properties,
                    ...
                    "semantic_schema_id": {"type": "string"},
                    "semantic_schema_version": {"type": "integer", "minimum": 1},
                    "objective": {"type": "string"},
                    "acceptance": {"type": "array", "items": {"type": "string"}, "minItems": 1},
                    "requirement_source_node_ids": {"type": "array", "items": {"type": "string"}},
                },
                "additionalProperties": False,
            },
        },
            ...
            "inputSchema": {
                ...
                "properties": {
                    **macro_patch_properties,
                    "region_id": {"type": "string"},
                    "verifier_id": {"type": "string"},
                    "artifact_source_node_id": {"type": "string"},
                    "semantic_schema_id": {"type": "string"},
                    "semantic_schema_version": {"type": "integer", "minimum": 1},
                    "objective": {"type": "string"},
                    "acceptance": {"type": "array", "items": {"type": "string"}, "minItems": 1},
            ...
            "inputSchema": {
                ...
                "properties": {
                    **macro_patch_properties,
                    ...
                    "evidence_source_port": {
                        "type": "string",
                        "enum": ["semantic_artifact", "verification_report"],
                    },
                    "planning_horizon": {"type": "integer", "minimum": 1},
                    "semantic_schema_id": {"type": "string"},
                    "semantic_schema_version": {"type": "integer", "minimum": 1},
                },
                "additionalProperties": False,
        ...
        "create_effectful_batch": {
            ...
            "description": "Create one declared implementation batch with checks and independent verification.",
            "inputSchema": {
                "type": "object",
                "required": [
                    "patch_id",
                ...
                "properties": {
                    **macro_patch_properties,
                    ...
                    "worker_id": {"type": "string"},
                    "verifier_id": {"type": "string"},
                    "plan_source_node_id": {"type": "string"},
                    "plan_verification_source_node_id": {"type": "string"},
                    "semantic_schema_id": {"type": "string"},
                    "semantic_schema_version": {"type": "integer", "minimum": 1},
                    "objective": {"type": "string"},
                    "acceptance": {"type": "array", "items": {"type": "string"}, "minItems": 1},
                    "checks": {"type": "array", "items": {"type": "object"}, "minItems": 1},
                    "rubric": {"type": "array", "items": {"type": "string"}, "minItems": 1},
                    "planning_horizon": {"type": "integer", "minimum": 1},
                    "requirement_source_node_ids": {"type": "array", "items": {"type": "string"}},
                    "accepted_plan_amendment_record_id": {"type": "string"},
                },
                "additionalProperties": False,
            },
        },
        "create_work_region": {
            ...
            "inputSchema": {
                ...
                "required": [
                    ...
                    "base_graph_position",
                    "region_id",
                    "failed_verification_source_node_id",
                    "failed_check_source_node_ids",
                    "failed_verification_record_id",
                ...
                "properties": {
                    **macro_patch_properties,
                    ...
                    "objective": {"type": "string"},
                    "access_mode": {"type": "string", "enum": ["read_only", "write"]},
                    "acceptance": {"type": "array", "items": {"type": "string"}},
                    "access_mode_override_justification": {"type": "string"},
                },
                "additionalProperties": False,
            },
        },
            ...
            "inputSchema": {
                ...
                "properties": {
                    **macro_patch_properties,
                    ...
                    "failed_verification_source_node_id": {"type": "string"},
                    "failed_check_source_node_ids": {
                        "type": "array",
                        "items": {"type": "string"},
                        "minItems": 1,
                    },
                    "failed_verification_record_id": {"type": "string"},
                    "failed_check_record_ids": {
                        "type": "array",
                        "items": {"type": "string"},
                        "minItems": 1,
                    },
                    "classified_gap_record_id": {"type": "string"},
                    "checks": {"type": "array", "items": {"type": "object"}},
                    "objective": {"type": "string"},
                    "access_mode": {"type": "string", "enum": ["read_only", "write"]},
                    "acceptance": {"type": "array", "items": {"type": "string"}},
