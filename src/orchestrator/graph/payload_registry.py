...
EVENT_PAYLOAD_SPECS: MappingProxyType[str, EventPayloadSpec] = MappingProxyType(
    {
        ...
        "file_state_accepted": _spec(
            "file_state_accepted",
            projection="base_snapshot_id candidate_id paths port producer_node_id record_id record_kind record_type schema snapshot_id supersedes_record_id task_region_id verdict",
        ...
        "file_state_rejected": _spec(
            "file_state_rejected",
            projection="base_snapshot_id candidate_id paths port producer_node_id reason record_id record_kind record_type schema snapshot_id supersedes_record_id task_region_id verdict",
