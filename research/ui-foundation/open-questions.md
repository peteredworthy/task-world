...
- **Q-7 — Hash-guard decisive implementation and test evidence** (resolved; blocking=False): Resolved: the 903-entry Phase 1 snapshot hashes every current src/orchestrator Python file, repository Python test, and UI source TS/TSX file; direct evidence records require matching declared snapshot paths.
