        ...
        <div className="flex-1 overflow-y-auto px-6 pb-5">
          ...
          <div className="mt-6">
              ...
              <a
                ...
                className="flex items-center gap-3 p-3 border border-border rounded-lg hover:bg-bg-hover transition-colors group"
              >
                <svg className="w-5 h-5 text-accent-purple shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25" />
                </svg>
                <div className="flex-1">
                  <div className="font-medium text-text-primary text-sm group-hover:text-accent-purple transition-colors">
                    Backend Architecture
                  </div>
                  <div className="text-xs text-text-muted mt-0.5">
                    Interactive diagrams of modules, layers, dependencies, and code distribution.
                  </div>
                </div>
