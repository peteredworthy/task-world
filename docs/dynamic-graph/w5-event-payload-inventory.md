...
Status: **closed 2026-07-16** at source head `bafeb650d27884ae5584f1fb4b4378780b4f587f`.
...
| `appeal_opened` | `graph_command_factory` | `AppealOpenedPayload` | 8/9/10/7 |
| `approval_decision_recorded` | `graph_command_factory` | `ApprovalDecisionRecordedPayload` | 10/12/15/7 |
| `authority_decision_recorded` | `graph_command_factory` | `AuthorityDecisionRecordedPayload` | 10/12/15/7 |
...
| `dead_input_detected` | `graph_command_factory` | `DeadInputDetectedPayload` | 7/7/7/7 |
...
| `oversight_decision_recorded` | `graph_command_factory` | `OversightDecisionRecordedPayload` | 10/12/15/7 |
...
| `run_lifecycle_changed` | `graph_command_factory` | `RunLifecycleChangedPayload` | 8/9/10/6 |
| `runtime_retry_scheduled` | `graph_command_factory` | `RuntimeRetryScheduledPayload` | 5/5/5/5 |
