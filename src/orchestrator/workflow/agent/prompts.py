...
def generate_builder_prompt(
    ...
    if task_config.work_mode == "oversight":
        system = (
            ...
            "6. Once all requirements are addressed and allowed docs/metadata changes are committed, "
            ...
            "- You MUST commit allowed documentation or metadata changes before submitting for verification.\n"
            "- The verifier will review the committed oversight artifacts and grade each requirement.\n"
